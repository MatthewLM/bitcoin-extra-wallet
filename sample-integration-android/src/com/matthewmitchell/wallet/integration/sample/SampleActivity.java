...
package com.matthewmitchell.wallet.integration.sample;
...
import com.matthewmitchell.wallet.integration.sample.R;
...
public class SampleActivity extends Activity
{
	...
	private void handleRequest()
	{
		...
		{
			final String[] addresses = donationAddresses();
			final CoinDetails details = Address.getCoinsFromAddress(addresses[0]).get(0);

			if (!details.isShapeShift())
				return;

			final NetworkParameters params = (NetworkParameters) details;
