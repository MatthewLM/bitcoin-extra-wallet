...
public class WalletUtils
{
	...
	@Nullable
	public static Address getAddressToDisplay(final Transaction tx, final Wallet wallet) {
		if (tx.getValue(wallet).signum() < 0)
			return WalletUtils.getToAddressOfSent(tx, wallet);
		else
			return WalletUtils.getWalletAddressOfReceived(tx, wallet);
	}
