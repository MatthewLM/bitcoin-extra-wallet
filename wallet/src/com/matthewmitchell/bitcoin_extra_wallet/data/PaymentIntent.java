...
package com.matthewmitchell.bitcoin_extra_wallet.data;
...
public final class PaymentIntent implements Parcelable
{
    ...
    public final List<CoinDetails> networks;
	...
	public PaymentIntent(@Nullable final Standard standard, @Nullable final String payeeName, @Nullable final String payeeVerifiedBy,
            ...
            @Nullable final String paymentRequestUrl, @Nullable final byte[] paymentRequestHash, @Nullable final List<CoinDetails> networks)
	{
    ...
    private PaymentIntent(final Address address, @Nullable final String addressLabel) {
        this(null, null, null, buildSimplePayTo(Coin.ZERO, address), addressLabel, null, null, null, null, address.getCoinDetails());
	}
	...
	public static PaymentIntent from(final String address, @Nullable final String addressLabel, @Nullable final Coin amount)
			throws WrongNetworkException, AddressFormatException
	{
		Address addrObj = Address.fromBase58(Constants.NETWORK_PARAMETERS, address);
		return new PaymentIntent(null, null, null, buildSimplePayTo(amount, addrObj), addressLabel,
				null, null, null, null, addrObj.getCoinDetails());
	}
	...
	public static PaymentIntent fromBitcoinUri(final BitcoinURI bitcoinUri)
	{
		...
		return new PaymentIntent(PaymentIntent.Standard.BIP21, null, null, outputs, bitcoinUri.getLabel(), bluetoothMac != null ? "bt:"
				+ bluetoothMac : null, null, bitcoinUri.getPaymentRequestUrl(), paymentRequestHash, address.getCoinDetails());
    }
        ...
        if (i != -1) {
            ...
            if (coin != null) {
                try {
                    ...
                    BitcoinURI uri = new BitcoinURI(coin, input);
                    return PaymentIntent.fromBitcoinUri(uri);
	...
	public PaymentIntent mergeWithEditedValues(@Nullable final Coin editedAmount, @Nullable final Address editedAddress)
	{
		...
		else
		{
            ...
            networks = editedAddress.getCoinDetails();
		}
	...
	public void writeToParcel(final Parcel dest, final int flags)
	{
        ...
        if (networks != null) {
            ...
            for (CoinDetails network: networks)
                dest.writeString(network.getUriScheme());
        }else
            dest.writeInt(0);
	}
	...
	private PaymentIntent(final Parcel in)
	{
        ...
        if (networkNum > 0) {
            networks = new ArrayList<CoinDetails>(networkNum);
