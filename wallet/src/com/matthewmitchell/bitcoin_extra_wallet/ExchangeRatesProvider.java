...
public class ExchangeRatesProvider extends ContentProvider
{
	...
	{
		public ExchangeRate(final org.bitcoinj_extra.utils.ExchangeRate rate, final String source)
		{
		...
		public final org.bitcoinj_extra.utils.ExchangeRate rate;
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder)
	{
		...
		if (selection == null)
		{
			for (final Map.Entry<String, ExchangeRate> entry : exchangeRates.entrySet())
			{
				...
				final org.bitcoinj_extra.utils.ExchangeRate rate = exchangeRate.rate;
	...
	public static ExchangeRate getExchangeRate(final Cursor cursor)
	{
		...
		return new ExchangeRate(new org.bitcoinj_extra.utils.ExchangeRate(rateCoin, rateFiat), source);
	}
						...
						for (final String field : fields)
						{
							...
							if (rateStr != null)
							{
								try
								{
									...
									if (rate.signum() > 0)
									{
										rates.put(currencyCode, new ExchangeRate(new org.bitcoinj_extra.utils.ExchangeRate(rate), source));
										break;
									}
								}
